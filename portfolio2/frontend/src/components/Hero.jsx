...
import { PixelStar, PixelArrow } from "@/components/PixelSparkle";
...
export default function Hero({ onStartProject }) {
  ...
  return (
    <section className="relative px-6 md:px-12 pt-16 md:pt-24 pb-12 overflow-hidden" data-testid="hero-section">
      ...
      <div className="max-w-6xl mx-auto relative">
        <motion.h1
          ...
          className="font-display text-[14vw] md:text-[12vw] lg:text-[10rem] leading-[0.85] font-black tracking-tighter"
          data-testid="hero-headline"
        >
          Let&apos;s build
          <br />
          <span className="italic font-light text-[var(--primary)]">together</span>
